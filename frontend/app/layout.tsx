  ...
  return (
    <html lang="en">
      <body className="min-h-screen" style={{ background: "var(--surface-bg)" }}>
        <AuthProvider>
          <nav className="px-6 py-4 flex gap-8 items-center shadow-md" style={{ background: "#0f172a", borderBottom: "1px solid #1e293b" }}>
            <span className="font-bold text-base tracking-tight" style={{ color: "#22d3ee" }}>⚡ HR Portal</span>
            ...
            <span className="ml-auto flex items-center gap-2 text-xs text-slate-400 bg-slate-800 px-3 py-1.5 rounded-full border border-slate-700">
              <span className="w-5 h-5 rounded-full bg-cyan-500 flex items-center justify-center text-white font-bold" style={{ fontSize: "10px" }}>AJ</span>
              Alice Johnson · E001
            </span>
          </nav>
          <main className="p-6">
